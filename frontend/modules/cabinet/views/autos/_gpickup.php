...
<style type="text/css">
    .side {
        ...
        height: 201px;
        width: 521px;
        background-image: url(../../uploads/img/autosparts/pickup.jpg);
    }
    .item {
        display: block;
    }
...
<div class="col-md-8 col-lg-7" align="center">
    ...
    <div class="side" style="transform: scale(-1, 1)">
        <? Pricetable::item('6', $point6, $view, $point6->price, $price_for6, $name6, $id, 'right', '2', '1') ?>
        <? Pricetable::item('7', $point7, $view, $point7->price, $price_for7, $name7, $id, 'right', '1', '1') ?>
    </div>
</div>
