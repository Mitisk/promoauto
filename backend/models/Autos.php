...
class Autos extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['auto_user_id', 'auto_location_id', 'auto_image', 'auto_price', 'auto_price_for', 'auto_type', 'auto_view', 'auto_mark_id', 'auto_model_id', 'auto_year', 'auto_city', 'auto_color', 'auto_damage', 'auto_parking', 'auto_comment', 'auto_confirmed', 'auto_occupied', 'auto_vip'], 'required'],
            [['auto_user_id', 'auto_location_id', 'auto_mark_id', 'auto_model_id', 'auto_year', 'auto_damage', 'auto_confirmed', 'auto_occupied', 'auto_vip'], 'integer'],
            [['auto_date'], 'safe'],
            [['auto_price'], 'number'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'auto_type' => 'Auto Type',
            'auto_view' => 'Auto View',
            'auto_mark_id' => 'Auto Mark ID',
            'auto_model_id' => 'Auto Model ID',
            'auto_year' => 'Auto Year',
            'auto_city' => 'Auto City',
            'auto_color' => 'Auto Color',
            'auto_damage' => 'Auto Damage',
